...
fixed_cfg <- list(
  ...
  mallow_ua        = 10                         # Mallows prior     (omit for queue-jump)
)
...
rj_cfg <- list(
  ...
  mallow_ua        = 10                         # used **only** for Mallows
)
