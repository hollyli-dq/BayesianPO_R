...
fixed_cfg <- list(
  ...
  mcmc_pt          = c(rho  = 0.30,             # update probabilities
                       noise = 0.30,
                       U     = 0.40),
  dr               = 0.10,                      # rho step
  rho_prior        = 0.16667,
...
args_fix$noise_beta_prior <- fixed_cfg$noise_beta_prior 
...
rj_cfg <- list(
  iters            = 10000,                      # total RJ iterations
  mcmc_pt          = c(rho  = 0.25,             # update probabilities
                       noise = 0.25,
                       U     = 0.30,
                       K     = 0.20),
  dr               = 0.10,                      # rho step
...
args_common$noise_beta_prior <- fixed_cfg$noise_beta_prior   # keep
